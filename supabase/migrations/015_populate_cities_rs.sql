-- Popular tabela cities com todas as cidades do Rio Grande do Sul
-- Formato: Cidade/UF (armazenado no campo name)
-- Migration: 015_populate_cities_rs.sql

-- Limpar cidades existentes do RS (opcional - descomente se quiser limpar antes de popular)
-- DELETE FROM young_talents.cities WHERE name LIKE '%/RS';

-- Inserir todas as cidades do RS no formato "Cidade/UF"
-- Usa ON CONFLICT para evitar duplicatas caso execute novamente
INSERT INTO young_talents.cities (name) VALUES
('Aceguá/RS'),
('Água Santa/RS'),
('Agudo/RS'),
('Ajuricaba/RS'),
...
-- Verificar quantas cidades foram inseridas
SELECT COUNT(*) as total_cidades_rs FROM young_talents.cities WHERE name LIKE '%/RS';

-- Nota: O dropdown no formulário exibirá as cidades no formato "Nome/UF" automaticamente
-- Exemplo: "Porto Alegre/RS", "Canoas/RS", etc.
